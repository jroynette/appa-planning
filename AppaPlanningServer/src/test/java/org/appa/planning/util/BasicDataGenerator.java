...
public class BasicDataGenerator {
	 ...
	 */
	public static Long generateRandomLong(long upperLimit) {
	 ...
	 */
	public static Long generateRandomLong(long upperLimit, boolean unique) {
		Long randomLong = null;

		if (unique) {
			do {
				randomLong = generator.nextLong()%upperLimit;
